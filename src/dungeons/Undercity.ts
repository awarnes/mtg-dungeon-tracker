...
const throne = new Room({
  ...
  effect: 'Reveal the top ten cards of your library. Put a creature card from among them onto the battlefield, then put three +1/+1 counters on it. It gains hexproof until your next turn. Then shuffle.'
});
